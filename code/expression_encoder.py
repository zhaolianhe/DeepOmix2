...
# Step 1: Load and preprocess RNAseq data
# Assume rnaseq_matrix.csv is your input file
rnaseq_matrix = pd.read_csv('rnaseq_matrix.csv', index_col=0)
data = rnaseq_matrix.values.astype('float32')

# Normalize data if necessary (e.g., log transformation)
data = np.log1p(data)
